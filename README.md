...
A REST API for creating, updating and retrieving Resumes (CVs) and a Resume browser as a <i>simple</i> client for consuming the API. I created this project during two weeks as a way of training in Spring and REST APIs. 
